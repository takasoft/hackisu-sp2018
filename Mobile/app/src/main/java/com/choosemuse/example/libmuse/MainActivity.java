...
public class MainActivity extends Activity implements OnClickListener {
     ...
     * hold the values of the last data packet received.  We are displaying the EEG.
     *
     * Note: the array lengths of the buffers are taken from the comments in
     * MuseDataPacketType, which specify 6
     * values for EEG and EEG-derived packets.
     */
    private final double[] eegBuffer = new double[6];
    private boolean eegStale;

    private boolean BlinkBlink, HeadOn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Make sure we have these permissions before proceeding.
        ensurePermissions();
    ...
    public void recieveMuseArtifactPacket (boolean headbandOn, boolean blink, boolean jawClench, long timestamp){
    ...
    public void receiveMuseArtifactPacket(final MuseArtifactPacket p, final Muse muse) {
        BlinkBlink = p.getBlink();
        artifactInfo = p.toString();
         System.out.println("BLAAAAAAA"+artifactInfo);
    }
